      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex gap-2 justify-center mb-8">
            ...
            <Button
              className={`rounded-lg px-6 py-3 text-sm font-medium transition-colors ${activeTab === "hired" ? "bg-primary text-white text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
